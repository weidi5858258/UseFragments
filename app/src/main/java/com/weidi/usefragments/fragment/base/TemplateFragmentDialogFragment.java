...
public class TemplateFragmentDialogFragment extends BaseDialogFragment {

    private static final String TAG =
            TemplateFragmentDialogFragment.class.getSimpleName();
    private static final boolean DEBUG = true;

    public TemplateFragmentDialogFragment() {
        super();
    }
