...
public class AvcEncoder {
    ...
    public AvcEncoder(int width, int height, int framerate, int bitrate) {
        ...
        try {
            ...
            //COLOR_FormatYUV420SemiPlanar  COLOR_FormatYUV420Planar
    ...
    private void swapYV12toI420(byte[] yv12bytes, byte[] i420bytes, int width, int height) {
        ...
        System.arraycopy(yv12bytes, width * height + width * height / 4, i420bytes, width *
                height, width * height / 4);
        System.arraycopy(yv12bytes, width * height, i420bytes, width * height + width * height /
                4, width * height / 4);
    }
