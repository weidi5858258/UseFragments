...
public class SimpleVideoPlayer3 {

    private static final String TAG =
            SimpleVideoPlayer3.class.getSimpleName();
    ...
    private void init() {
        ...
        mThreadHandler = new Handler(mHandlerThread.getLooper()) {
            ...
            public void handleMessage(Message msg) {
                SimpleVideoPlayer3.this.threadHandleMessage(msg);
            }
        };
        mUiHandler = new Handler(Looper.getMainLooper()) {
            @Override
            public void handleMessage(Message msg) {
                SimpleVideoPlayer3.this.uiHandleMessage(msg);
            }
        };
    }
