...
public class SampleVideoPlayer7 {
    ...
    private void readData1ToHandleData(SimpleWrapper wrapper) {
    ...
    private void readData2ToHandleData(SimpleWrapper wrapper) {
